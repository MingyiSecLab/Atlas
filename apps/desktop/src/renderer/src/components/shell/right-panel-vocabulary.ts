...
import { Compass, FileSearch, FolderCode, ShieldCheck, SquareTerminal } from 'lucide-react'

export const RIGHT_PANEL_SECTIONS = ['terminal', 'browser', 'files', 'pentest', 'audit'] as const
...
export const RIGHT_PANEL_SECTION_DEFINITIONS: RightPanelSectionDefinition[] = [
  ...
  { id: 'audit', label: '审计', icon: FileSearch }
]
